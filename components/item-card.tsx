...
export default function ItemCard(props: Props) {
  ...
  const type = React.useMemo(() => {
    const safeDescription = item.title.replace(/ \(.+\)/g, "");

    if (item.title.length < 60 && !/\d\d/.test(safeDescription)) {
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: `url("https://image.tmdb.org/t/p/w220_and_h330_face${item.poster_path}")`,
                }}
              ></div>
              <animated.div
